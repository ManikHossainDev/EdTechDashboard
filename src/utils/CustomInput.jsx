      ...
      <div className="relative">
        ...
        {isTextArea ? (
          <Input.TextArea
            ...
            className={`w-full px-4 py-2 text-[16px] border border-[#FF9E1C] text-[#0a0a0a] rounded-lg resize-none  ${className}`} // Custom styling
          ...
          <Input.Password
            ...
            className={`w-full px-4 py-2 text-[16px] border border-[#FF9E1C] text-[#0a0a0a] rounded-lg ${className}`}
            {...rest} // Additional props
          />
          ...
          <input
            ...
            className={`w-full px-4 py-2 text-[16px] border border-[#FF9E1C] text-[#0a0a0a] rounded-lg ${className}`} // Custom styling
            accept="image/*"
            {...rest} // Additional props
          />
        ) : (
          <Input
            ...
            className={`w-full px-4 py-2 text-[16px] border border-[#FF9E1C] text-[#000000] rounded-lg ${className}`}
